import clapAnalyzer, clapDetector, requestHandler
import time
import os
import serial
import struct
...
def set_mapping_string(input_string):
	global json_string 
	json_string = input_string
	print('set JSON to {0}'.format(input_string))

# create a clapDetector instance listening on GPIO21
...
# start webserver and register post listeners
Handler = requestHandler.CustomHandler
Handler.add_post_listener(set_mapping_string)
